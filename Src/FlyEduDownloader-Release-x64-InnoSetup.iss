...
OutputBaseFilename=FlyEduDownloader_1.0.4.24101_x64_setup
...
UninstallDisplayName=飞翔教学资源助手 1.0.4.24101 (x64)
...
WelcomeLabel2=现在将安装 飞翔教学资源助手 到您的电脑中。%n%n推荐您在继续安装前关闭所有其它应用程序。%n%n编译日期：2024-10-05。%n%n版本：1.0.4.24101 x64
...
//自己的appID
SubKeyName :=  'Software\Microsoft\Windows\CurrentVersion\Uninstall\{85F3616B-7A4C-4EED-B00B-DF6866141220}_is1';
    RegWriteStringValue(HKLM,SubKeyName,'DisplayName','飞翔教学资源助手 1.0.4.24101 (x64)');
  end;
end;
