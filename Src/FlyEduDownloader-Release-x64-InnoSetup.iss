...
OutputBaseFilename=FlyEduDownloader_1.0.10.25071_x64_setup
...
UninstallDisplayName=飞翔教学资源助手 1.0.10.25071 (x64)
...
//自己的appID
SubKeyName :=  'Software\Microsoft\Windows\CurrentVersion\Uninstall\{85F3616B-7A4C-4EED-B00B-DF6866141220}_is1';
    RegWriteStringValue(HKLM,SubKeyName,'DisplayName','飞翔教学资源助手 1.0.10.25071 (x64)');
  end;
end;
