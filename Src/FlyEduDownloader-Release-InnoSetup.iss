...
AppName=飞翔教学资源助手
AppVersion=1.0.10.25071
;AppVerName=FlyEduDownloader 1.0.10.25071
AppPublisher=CJH
...
OutputBaseFilename=FlyEduDownloader_1.0.10.25071_x86_setup
...
VersionInfoVersion=1.0.10.25071
VersionInfoProductName=FlyEduDownloader 1.0.10.25071
VersionInfoProductVersion=1.0.10.25071
...
UninstallDisplayName=飞翔教学资源助手 1.0.10.25071
...
WelcomeLabel2=现在将安装 飞翔教学资源助手 到您的电脑中。%n%n推荐您在继续安装前关闭所有其它应用程序。%n%n编译日期：2025-7-6。%n%n版本：1.0.10.25071
...
SubKeyName :=  'Software\Wow6432Node\Microsoft\Windows\CurrentVersion\Uninstall\{9FAF52FE-D96C-4DA1-853D-15D56DE424F8}_is1';
    RegWriteStringValue(HKLM64,SubKeyName,'DisplayName','飞翔教学资源助手 1.0.10.25071 (x86)');
  end else begin
SubKeyName :=  'Software\Microsoft\Windows\CurrentVersion\Uninstall\{9FAF52FE-D96C-4DA1-853D-15D56DE424F8}_is1';
    RegWriteStringValue(HKLM,SubKeyName,'DisplayName','飞翔教学资源助手 1.0.10.25071');
  end;
end;
