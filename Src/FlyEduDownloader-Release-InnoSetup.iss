...
OutputBaseFilename=FlyEduDownloader_1.0.7.25021_x86_setup
...
UninstallDisplayName=飞翔教学资源助手 1.0.7.25021
...
SubKeyName :=  'Software\Wow6432Node\Microsoft\Windows\CurrentVersion\Uninstall\{9FAF52FE-D96C-4DA1-853D-15D56DE424F8}_is1';
    RegWriteStringValue(HKLM64,SubKeyName,'DisplayName','飞翔教学资源助手 1.0.7.25021 (x86)');
  end else begin
SubKeyName :=  'Software\Microsoft\Windows\CurrentVersion\Uninstall\{9FAF52FE-D96C-4DA1-853D-15D56DE424F8}_is1';
    RegWriteStringValue(HKLM,SubKeyName,'DisplayName','飞翔教学资源助手 1.0.7.25021');
  end;
end;
